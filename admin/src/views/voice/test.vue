    ...
    <el-card shadow="never">
      ...
      <div v-show="currentStep === 0" class="step-content">
        <el-form :model="uploadForm" label-width="120px" style="max-width: 600px">
          <el-form-item label="音色名称" required>
            <el-input v-model="uploadForm.name" placeholder="给音色起个名字，便于识别" clearable />
          ...
          <el-form-item label="前缀标识" required>
            ...
            />
            <div class="form-tip">⚠️ 必须使用英文字母和数字，例如：xiaoming、kefu01、voice001</div>
          </el-form-item>

          <el-form-item label="选择模型" required>
            <el-select v-model="uploadForm.targetModel" style="width: 100%">
              <el-option label="CosyVoice v2 (基础版，速度快)" value="cosyvoice-v2" />
              <el-option label="CosyVoice v3 (标准版，效果好)" value="cosyvoice-v3" />
              <el-option label="CosyVoice v3 Plus (高级版，效果最佳)" value="cosyvoice-v3-plus" />
            </el-select>
      ...
      <div v-show="currentStep === 1" class="step-content">
        ...
        >
          <template #extra>
            ...
            <div class="mt-4">
              <el-button type="primary" :loading="true"> 训练中...（约需1-5分钟） </el-button>
              <el-button @click="checkTrainingStatus"> 手动刷新状态 </el-button>
            </div>
          </template>
        </el-result>
        ...
        >
          <template #extra>
            <el-button type="primary" @click="backToUpload"> 返回重新上传 </el-button>
          </template>
        </el-result>
      ...
      <div v-show="currentStep === 2" class="step-content">
            ...
            <el-card shadow="never" class="param-card">
              ...
              <el-form label-width="100px">
                ...
                <el-form-item label="情绪">
                  ...
                  <div class="param-tip">⚠️ 仅cosyvoice-v3默认音色支持，声音复刻暂不支持</div>
                </el-form-item>
            ...
            <el-card shadow="never" class="preview-card">
              ...
              <div v-if="previewUrl" class="preview-content">
                ...
                <div class="audio-actions mt-3">
                  <el-button type="primary" :icon="VideoPlay" @click="playAudio"> 播放 </el-button>
                  <el-button :icon="VideoPause" @click="pauseAudio"> 暂停 </el-button>
                  <el-button :icon="Download" @click="downloadAudio"> 下载 </el-button>
                </div>
              ...
              <el-empty v-else description="点击【生成试听】按钮生成音频" :image-size="120" />
            </el-card>
          </el-col>
        </el-row>
        ...
        <div class="step-actions text-center">
          ...
          <el-button type="success" @click="finishTest"> 完成测试 </el-button>
        </div>
      </div>
    </el-card>
  </div>
