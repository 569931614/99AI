...
// 移除各种括号及其内容，避免浏览器朗读心理描写/舞台指令
function removeBracketedContent(text: string | null | undefined): string {
  if (!text) return ''
  let result = text
...
function playBrowserTts() {
  ...
  const cleaned = removeBracketedContent(props.content)
  speechSynthesisUtterance = new SpeechSynthesisUtterance(cleaned)
